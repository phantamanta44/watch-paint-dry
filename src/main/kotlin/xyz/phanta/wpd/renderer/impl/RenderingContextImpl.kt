...
class RenderableContext(private val bindings: Map<String, Any>, private val children: List<Renderable>) : RenderingContext {
    ...
    override fun <T : Resolved> resolveReference(type: ResolutionType<T>, identifier: String): T? = type.ensure(identifier, bindings[identifier])
...
class ConjoinedNameResolver(private val primary: NameResolver, private val fallback: NameResolver) : NameResolver {
    ...
    override fun <T : Resolved> resolveReference(type: ResolutionType<T>, identifier: String): T? = primary.resolveReference(type, identifier)
